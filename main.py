...
def get_artists_route():
    if request.method == "POST":
        data = Artists.get(request.form.get("genre"), True if request.form.get("popularity")=="on" else False, request.form.get("popularity-val"), limit= request.form.get("limit"))
